...
function draw() {
  ...
  detectCollision(polygon,blocks1);
  detectCollision(polygon,blocks2);
  detectCollision(polygon,blocks3);
  detectCollision(polygon,blocks4);
  detectCollision(polygon,blocks5);
  detectCollision(polygon,blocks6);
  detectCollision(polygon,blocks7);
  detectCollision(polygon,blocks8);
  detectCollision(polygon,blocks9);
}
...
function detectCollision(p,b){
  ...
  var distance = dist(pbody.x, pbody.y, bbody.x, bbody.y);
  if(distance <= 50){
    Body.setStatic(bbody, false);
  }
}
